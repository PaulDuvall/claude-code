...
# Claude Code Hook: Cleanup On Stop
#
# Description: Performs security cleanup when execution stops
# Purpose: Prevent sensitive data persistence by cleaning temporary state on stop
# Trigger: Stop
# Blocking: No
# Tools: *
...
# Configuration
##################################
HOOK_NAME="cleanup-on-stop"
LOG_FILE="$HOME/.claude/logs/cleanup-on-stop.log"
...
main() {
    ...
    # TODO: Add specific validation logic for cleanup-on-stop
